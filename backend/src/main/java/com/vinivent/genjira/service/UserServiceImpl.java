...
public class UserServiceImpl implements UserDetailsService, IUserService {
    ...
    private final IUserVerifiedRepository userVerifiedRepository;
    private final IPasswordResetTokenRepository resetTokenRepository;
    private final PasswordEncoder passwordEncoder;
    private final IMailService mailService;

    public UserServiceImpl(IUserRepository userRepository, IUserVerifiedRepository userVerifiedRepository,
                           IPasswordResetTokenRepository resetTokenRepository, PasswordEncoder passwordEncoder,
